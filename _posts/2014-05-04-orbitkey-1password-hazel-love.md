...
{% render figure, src: "/assets/images/blog/orbitkey.jpg", alt: "photo of an Orbitkey on a wooden surface with keys and other accessories attached", caption: "My Orbitkey with my keys and 32GB USB flash drive folded out for access" %}
...
{% render figure, src: "/assets/images/blog/1password-anywhere.png", alt: "the 1Password Anywhere master password prompt", caption: "1Password Anywhere opened in Safari" %}
