---
date: 2026-03-06T19:46:06+11:00
title: Apple has lost me as an enthusiast customer
visibility: public
tags:
  - Apple
  - tech
...
In 2020 I bought an LG CX 48-inch 4K OLED TV, which at the time was hailed as a bit of a wonder: a leading-edge OLED TV, capable of full HDR (including Dolby Vision), perfect blacks, and frame rates up to 120KHz, all in a unit small enough (just!) to fit on a desk. I could also connect it to gaming consoles and other video sources – a versatile and top-quality display for anything I might want, right there on my desk.
...
{% render figure, src: "/assets/images/blog/apple-has-lost-me-as-an-enthusiast-customer/IMG_2505.jpeg", alt: "Photo of a large desktop monitor showing the Google home page open in a full-screen browser window. The white background of the web page shows clear signs of burn-in.", caption: "You can almost smell the pixels cooking" %}
...
This week, Apple raised the curtain on a pair of new displays: a slightly updated Studio Display, and a new Studio Display XDR (27-inch). Though it doesn't have the 32-inch size that might have preserved the "edgeless canvas" experience that I still love, this monitor should nevertheless be for me: it's got bright highlights and inky blacks nearly a match to an OLED panel (with only very slight blooming on high-contrast edges), the same amazing HDR colour depth and 120Hz refresh rate, all with Retina resolution – more than double the pixels-per-inch I've been living with. The price they're asking is still high, but within reach for someone like me who stares at a monitor professionally and as a hobbyist for most of their waking hours.

So why am I not buying one? That's where the Vision Pro comes in. I was extremely tempted to buy a Vision Pro at launch. Apple has designed it as a push into a new future for computer user experiences. I am a career user experience nerd, the exact kind of person Apple would want playing with this new product, building things for it in my spare time. As soon as I could, [I took the in-store demo](/posts/apple-vision-pro-demo-review/), loved every second of it, then went home and stared at the price tag. Ultimately, I could not justify it to myself. Not because I couldn't afford it, but because it just wasn't worth the asking price.
...
I wish Apple could see that open standards and low barriers to entry – not just beautiful walled gardens – are necessary to move the state of the art forward. It used to know that, and the enduring success of the Mac is testament to it. But the disruptive innovation that was iPhone seems to have made it forget this, as Apple has pursued the same business model for every new product since.
...
And as news breaks today that [Google is opening up Android as a platform even more](https://pxlnv.com/linklog/google-epic-games-settlement/), I am closer now than I have been in fifteen years to buying something other than an iPhone for my next handheld computer.
